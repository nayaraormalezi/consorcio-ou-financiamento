...
export const CREDIT_VALUE_PRESETS = [150_000, 200_000, 300_000, 500_000, 800_000, 1_000_000] as const
...
export function createDefaultInput(): SimulatorInput {
  ...
  return {
    ...
    consortiumInsuranceMode: 'monthly',
    ...
    consortiumHasMembershipFee: false,
    ...
    amortization: 'sac',
    financingHasInsurance: false,
    financingInsuranceMonthly: 0,
    financingHasOtherCosts: false,
    originationFee: 0,
    appraisalFee: 0,
    registryFee: 0,
    otherUpfront: 0,
